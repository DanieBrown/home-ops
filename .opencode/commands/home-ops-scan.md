...
If Zillow blocks on sign-in or human verification, the scan command should skip Zillow for the rest of that scan, continue with the other platforms, and tell the user to rerun `/home-ops scan --zillow` after clearing the blocker.
